...
export const QiblaModal: React.FC<QiblaModalProps> = ({ visible, onClose, latitude, longitude, inline }) => {
    ...
    <View style={[styles.container, inline && styles.inlineContainer]}>
      <View style={styles.header}>
        <View style={[styles.titleGroup, isRTL && { flexDirection: 'row-reverse' }]}>
            ...
            <Text style={[styles.title, isRTL ? { marginRight: 10 } : { marginLeft: 10 }]}>{t.qibla}</Text>
        </View>
        {!inline && (
        ...
        <View style={styles.compassWrap}>
           ...
           <Svg height="300" width="300" viewBox="0 0 100 100">
              <G rotation={compassRotation} origin="50, 50">
                <Circle cx="50" cy="50" r="48" stroke="#c5a35e" strokeWidth="1" fill="rgba(197, 163, 94, 0.05)" />
                
                {/* Degree Markers */}
                {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map(degree => (
                    <G key={degree} rotation={degree} origin="50, 50">
                        <Line x1="50" y1="2" x2="50" y2="8" stroke="#c5a35e" strokeWidth="0.5" />
                        <SvgText
                            x="50"
                            y="15"
                            fontSize="6"
                        ...
                        >
                            {degree === 0 ? 'N' : degree === 90 ? 'E' : degree === 180 ? 'S' : degree === 270 ? 'W' : ''}
                        </SvgText>
                    </G>
                ))}
              </G>
              ...
              <G rotation={qiblaRelativeRotation} origin="50, 50">
                 ...
                 <Path
                    ...
                    strokeWidth="1"
                 />
                 <Line x1="50" y1="30" x2="50" y2="50" stroke="#c5a35e" strokeWidth="1.5" />
                 
                 {/* Mosque Icon (Simple Path) */}
                 <G transform="translate(42, 5) scale(0.15)">
                    <Path 
                        d="M25 0 L50 20 L50 50 L0 50 L0 20 Z" 
                        fill="#c5a35e"
                    />
                 </G>
              </G>
