...
export const AzkarModal: React.FC<AzkarModalProps> = ({
  visible,
  onClose,
  type,
  inline,
      ...
      <View style={styles.header}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          {inline && (
            <TouchableOpacity
              onPress={() =>
                onTypeChange?.(type === "morning" ? "evening" : "morning")
              }
              style={[styles.headerBtn, { marginRight: 15 }]}
            >
              {type === "morning" ? (
                <Moon size={20} color="#e2d1a8" />
              ) : (
          ...
          return (
            ...
            >
              <Text
                style={[
                  styles.azkarText,
                  { fontSize: currentSettings.fontSize + 2 },
                  isFinished && styles.azkarTextFinished,
                ]}
              >
                {item.text}
              </Text>
